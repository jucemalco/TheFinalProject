        ...
        <div className="container">
            ...
            <form onSubmit={(evento) => onSubmit(evento)}>
                <div className="mb-3 ms-4 me-4">
                    <label for="exampleInputNombre" className="form-label d-flex text-white">
                        Nombre <i className="fa fa-asterisk fa-xs " style={{ fontSize: 6, color: "#fd4444" }}></i>
                    </label>
                    <input
                        name="name"
                        type="text"
                ...
                <div className="mb-3 ms-4 me-4">
                    <label for="exampleInputApellido" className="form-label d-flex text-white">
                ...
                <div className="mb-3 ms-4 me-4">
                    <label for="exampleInputEmail" className="form-label d-flex text-white">
                        Correo Electrónico <i className="fa fa-asterisk fa-xs" style={{ fontSize: 6, color: "#fd4444" }}></i>
                    </label>
                    <input
                        name="email"
                        type="email"
                ...
                <div className="asterisk d-flex ms-4">
                    ...
                    <i className="fa fa-asterisk  p-2" style={{ fontSize: 6, color: "#fd4444" }}></i>Campos Obligatorios
                </div>

                <button className="btn btn-outline-light gradient-custom-1 mt-3" type="submit">
                    Crear una cuenta
                </button>
