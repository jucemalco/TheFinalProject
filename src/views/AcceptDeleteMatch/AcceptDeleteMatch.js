...
//                         <button type="submit" className="btn btn-outline-light mb-2 m-2 p-2 gradient-custom-1 px-4">Aceptar Match</button>
//                         <button type="submit" className="btn btn-outline-light mb-2 m-2 p-2 gradient-custom-1 px-4">Eliminar Match</button>
//                     </div>
//                 </div>
